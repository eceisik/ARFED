...
for iteration in range(iteration_num):
    ...
    tn.start_train_end_node_process_with_clipping(number_of_samples, x_train_dict, y_train_dict, x_test_dict,
                                                  ...
                                                  device, clipping=is_clipping, clipping_threshold=10)
    ...
    iteration_distance, iteration_threshold = tn.get_outlier_situation_and_thresholds_for_layers(iteration_distance, factor)
